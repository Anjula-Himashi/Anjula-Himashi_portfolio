      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          <div className="w-full md:w-1/2 space-y-6">
            <div>
              <AnimatedText text="Anjula Himashi" className="text-4xl md:text-5xl font-bold tracking-tight" />
              <AnimatedText
            ...
            >
              Third-year Computer Science undergraduate at the University of Colombo School of Computing, passionate about creating impactful digital solutions for real-world problems. Fast learner, team player, and aspiring Software Engineer.
            </ClientMotion>
            <ClientMotion
            ...
            >
              ...
              <Button variant="secondary" asChild className="relative overflow-hidden group">
                <Link href="/documents/anjula-himashi-resume.pdf" target="_blank" download>
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl">
              <Image src="/images/profile.jpg" alt="Anjula Himashi" fill className="object-cover" priority />
